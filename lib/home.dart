...
class HomeScreen extends StatefulWidget {
  HomeScreen({Key key, this.title = 'Media TV'}) : super(key: key);
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  static const String beeUri = 'http://shinestream.in:1935/mediatv/mediatv/playlist.m3u8';
  ...
  Widget _buldImage() {
    return Center(
      child: Image.asset('assets/images/cant.png'),
    );
  }
  ...
  Color gradientStart = Color(0xff1c2029); //Change start gradient color here
  Color gradientEnd = Color(0xff1c2029); //Change end gradient color here
